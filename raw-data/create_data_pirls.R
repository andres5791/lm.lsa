...
if(FALSE){
  ...
  setwd(getwd()) # %YOUR FOLDER HERE%

  outdir <- tempdir() %OUTPUT FOLDER HERE%

  ILSAmerge::ILSAmerge( file.path("TIMSS&PIRLS2011_IDB_SPSS","Data"),
             file.path(outdir,"TIMSS_PIRLS_2011"))

  ILSAmerge::ILSAmerge( file.path("PIRLS2001_IDB_SPSS","Data"),
             file.path(outdir,"PIRLS2001"))

  ILSAmerge::ILSAmerge( file.path("PIRLS2006_IDB_SPSS","Data"),
             file.path(outdir,"PIRLS2006"))

  ILSAmerge::ILSAmerge( file.path("PIRLS2016_IDB_SPSS","Data"),
